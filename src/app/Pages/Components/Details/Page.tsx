  ...
  return (
    <div className="pt-20 lg:mt-10 flex flex-col lg:flex-row relative p-5 min-h-[12%] w-full bg-orange-100">
      <div className="w-full lg:w-2/3 p-1 mx-4" data-aos="fade-up" data-aos-delay="500">
        <h1 className={`font-extrabold pb-1 text-4xl lg:text-6xl text-gray-800 ${montserrat.className}`}>
          FREE!! 100-Day Self-Study Plan to Learn Data Engineering
        </h1>
        <br />
        <div className="w-full">
          <p className={`text-2xl py-3 text-gray-800 ${inter.className}`}>
          ...
          <h2 className={`pt-3 text-2xl text-gray-800 ${inter.className}`}>
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:justify-start items-center space-y-4 lg:space-y-0 lg:space-x-4 mt-6 w-full">
          <a href="/assets/Pdf/Plan.pdf" download="100-Day-Data-Engineering-Plan">
            <button className="flex items-center justify-center px-10 py-5 rounded-xl h-20 bg-red-400 border-3 border-black text-white text-3xl lg:text-4xl lg:w-auto" data-aos="fade-up" data-aos-delay="400">
              Download
              <Lottie {...downloadOptions} className="ml-2" style={{ height: '80px', width: '90px' }} />
            </button>
          </a>
        </div>
      </div>
      <div className="w-full lg:w-2/5 justify-center items-center" data-aos="fade-up" data-aos-delay="500">
        <FlashMessage />
